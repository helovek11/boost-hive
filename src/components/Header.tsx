      ...
      <div className="flex items-center gap-4 lg:gap-8">
        <div className="flex items-center gap-3 bg-hive-amber/10 border border-hive-amber/20 px-4 py-2 rounded-full">
          <div className="flex flex-col items-end">
            ...
            <span className="font-mono font-bold text-hive-amber text-sm">₽{user?.balance?.toFixed(2) || '0.00'}</span>
          </div>
          <button
        ...
        <div className="flex items-center gap-1 sm:gap-4 border-l border-white/5 sm:pl-6 pl-2">
          ...
          <div className="relative" ref={notifRef}>
            <button
              ...
              className="p-2 text-white/30 hover:text-hive-amber transition-colors relative block"
            >
              <Bell size={20} />
            ...
            {showNotifications && (
              <div className="absolute right-0 max-sm:left-4 max-sm:right-4 top-12 w-80 bg-hive-dark border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50">
          ...
          <div className="relative" ref={settingsRef}>
            <button
              ...
              className="block p-2 text-white/30 hover:text-hive-amber transition-colors"
            >
              <Settings size={20} />
            </button>

            {showSettings && (
              <div className="absolute right-0 max-sm:left-4 max-sm:right-4 top-12 w-72 bg-hive-dark border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50">
                <div className="p-4 border-b border-white/5 flex justify-between items-center">
